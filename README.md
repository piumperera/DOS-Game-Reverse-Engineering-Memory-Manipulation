...
This project demonstrates practical reverse engineering techniques by analyzing a legacy DOS game (DOOM) to understand its internal behavior without source code access.  

The focus is on identifying, analyzing, and manipulating the player’s health value in memory during runtime.

Using tools like Cheat Engine and DOSBox-X Debugger, the project explores how game data is stored and updated, differentiates between front-end (display) and back-end (actual logic) values, and locates the core assembly instruction responsible for health reduction.  

By modifying this instruction, the game behavior is altered to prevent health decrease.
